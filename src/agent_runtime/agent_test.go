...
func TestAddTool(t *testing.T) {
	...
	if agent.tools[0].Name != "added_tool" {
		t.Errorf("Expected tool name 'added_tool', got %q", agent.tools[0].Name)
	}
}
...
func TestGetTools(t *testing.T) {
	...
	// In openai-go v3, ChatCompletionFunctionTool returns a union param
	// where the function tool is stored in OfFunction.

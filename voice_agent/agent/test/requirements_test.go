...
func TestNewTaskRequirements(t *testing.T) {
	req := NewTaskRequirements("sess_1", "user_1")
...
func TestRefreshCollectedFields_OptionalFields(t *testing.T) {
	...
	req.ReferenceFiles = []ReferenceFileReq{{FileID: "f1"}}
	req.RefreshCollectedFields()
...
func TestFormatProfileSummary_Nil(t *testing.T) {
	result := formatProfileSummary(nil)
	if result != "暂无画像信息。" {
...
func TestFormatProfileSummary_Empty(t *testing.T) {
	result := formatProfileSummary(&UserProfile{})
	if result != "暂无画像信息。" {
...
func TestFormatProfileSummary_Populated(t *testing.T) {
	...
	result := formatProfileSummary(profile)
...
func TestToPPTInitRequest(t *testing.T) {
	req := makeFullRequirements()
	req.ReferenceFiles = []ReferenceFileReq{
...
func TestBuildDetailedDescription_Full(t *testing.T) {
	...
	desc := buildDetailedDescription(req)
...
func TestBuildDetailedDescription_Nil(t *testing.T) {
	result := buildDetailedDescription(nil)
	if result != "" {
...
func makeFullRequirements() *TaskRequirements {
	req := NewTaskRequirements("sess_test", "user_test")
	req.Topic = "高等数学"
